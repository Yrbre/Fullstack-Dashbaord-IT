                ...
                <div class="schedule-container">
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-date">{{ $task->parent->name ?? '-' }}</div>
                        </div>
                        {{-- Job Owner --}}
                        <div class="timeline-item">
                            <div class="timeline-dot"></div>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-date">Start:
                                {{ Carbon\Carbon::parse($task->schedule_start)->format('d M Y H:i') ?? '-' }}</div>
                            <div class="timeline-date">End:
                                {{ Carbon\Carbon::parse($task->schedule_end)->format('d M Y H:i') ?? '-' }}</div>
                            <div class="timeline-date">Duration: {{ $durationSchedule }}</div>
                        </div>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-date">Start:
                                {{ Carbon\Carbon::parse($mailData->start_time)->format('d M Y H:i') ?? '-' }}</div>
                            <div class="timeline-date">End:
                                {{ $mailData->end_time ? Carbon\Carbon::parse($mailData->end_time)->format('d M Y H:i') : '-' }}
                            </div>
                            <div class="timeline-date">Duration: {{ $durationActual }}</div>
                        </div>
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-date">{{ $mailData->description }}</div>
                        </div>
                    </div>
