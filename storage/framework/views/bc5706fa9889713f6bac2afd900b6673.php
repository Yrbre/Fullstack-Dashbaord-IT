<?php $__env->startSection('judul', 'Task Department Create'); ?>
...
unset($__errorArgs, $__bag); ?>" id="select-level"
                            ...
                            <optgroup label="Select Level Type">
                                ...
                                <option value="DEPARTMENT" <?php if(old('task_level') == 'DEPARTMENT'): ?> selected <?php endif; ?>>DEPARTMENT
                                </option>
                            </optgroup>
                        </select>
                        ...
                        <select class="form-control select2" id="select-department" name="enduser_department">
                            <optgroup label="Select Department">
                                ...
                                <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" <?php if(old('enduser_department') == $item->id): ?> selected <?php endif; ?>>
                                        <?php echo e($item->department); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </optgroup>
                            <option value="OTHER" <?php if(old('enduser_department') == 'OTHER'): ?> selected <?php endif; ?>>OTHER</option>
                        </select>
                    </div>
                    <div class="form-group col-6" id="otherDepartmentInput" style="display: none;">
                        ...
                        <input type="text" class="form-control" id="other_department" name="other_department"
                            placeholder="Enter custom department" value="<?php echo e(old('other_department')); ?>">
                    </div>
                            ...
                            <optgroup label="Select Personal">
                                ...
                                <?php $__currentLoopData = $endUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>"
                                        <?php if(old('enduser_personal') == $item->id): ?> selected <?php endif; ?>>
                                        <?php echo e($item->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" id="select-status"
                            ...
                            <optgroup label="Select Status Type">
                                ...
                                <option value="ON PROGRESS" <?php if(old('status') == 'ON PROGRESS'): ?> selected <?php endif; ?>>IN PROGRESS
                                </option>
