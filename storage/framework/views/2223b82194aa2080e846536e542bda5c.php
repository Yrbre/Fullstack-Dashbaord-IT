...
<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="post" id="myForm" action="<?php echo e(route('task_personal.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="form-row">
...
unset($__errorArgs, $__bag); ?>" value="PERSONAL"
                    ...
                    <div class="form-group col-6">
                        ...
                        <select class="form-control select2 <?php $__errorArgs = ['enduser_personal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php $__errorArgs = ['enduser_personal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
