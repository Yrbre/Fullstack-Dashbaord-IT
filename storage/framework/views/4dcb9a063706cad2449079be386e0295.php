                                ...
                                <div class="d-flex flex-column" style="gap: 1rem;">
                                    ...
                                    <div class="rounded-lg p-3 text-center">
                                        ...
                                        <button type="button"
                                            ...
                                            data-url="<?php echo e(route('dashboard_operator.take_onspot', 9)); ?>">
                                            TAKE
                                        </button>
                                    </div>
            ...
            <div id="activityRoutineListTemplate" style="display: none;">
                <div style="max-height:400px; overflow-y:auto;" data-simplebar>
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $routineActivityList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
